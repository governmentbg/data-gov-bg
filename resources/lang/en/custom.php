...
return [
  ...
  */
  ...
  'no_dataset_found' => 'No Data Set found!',
  ...
  'admin_regular_news' => 'Regular news',
  'admin_latest_news' => 'Make home page latest news',
  'admin_alert_news' => 'Alert news',
  'admin_news_is_for' => 'News type',
  ...
  'delete_help_subsection' => 'The deleting of a section will lead to the deletion of its subsections',
  ...
  'create_discussion_error' => 'Only admins can create discussions!',
  'create_response_error' => 'Only authenticated users can add comments to discussion!',
  'forum' => 'forum',
  'category' => 'Category',
  'views' => 'Views count',
  ...
  'conn_success' => 'Connection success',
  ...
  'conn_delete_success' => 'Connection deleted successfully',
  'conn_delete_error' => 'Connection not deleted successfully',
  ...
  'dataset_access' => 'Data set access',
  'free_access' => 'paid',
  'paid_access' => 'free of charge',
  'paid' => 'paid',
  'free' => 'free of charge',
  'page_404_text' => 'The page you are looking for could not be found! You can navigate to the home page',
  'page_500_text' => 'An error has occurred! You can try to reload the page or navigate to the home page',
  'page_505_text' => 'An error has occurred! You can try to reload the page or navigate to the home page',
  'resource_pagination_info' => 'Showing %s to %s of %s entries',
  'resources_only_zip' => '.zip with all resources',
  'resources_zip_link' => '.zip with all resources in %s format',
  'zip_download_info' => 'Depending on the size and number of resources <br> creating the .zip file may take some time.',
  'zip_download_fail' => 'An error has occurred while trying to generate the .zip file. Please try again.',
  'zip_download_error' => 'An error has occurred while downloading the .zip file.',
  'old_dataset_not_found' => 'The old data set was not found',
  'move_resources_to_new_dataset' => 'Move the resources to a data set with ID',
  ...
  'resources_link_in_format' => 'Download link in <b>%s</b> format:',
