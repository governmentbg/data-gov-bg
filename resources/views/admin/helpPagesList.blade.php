...
<div class="container admin">
    ...
    <div class="row">
        <div class="col-xs-6 m-t-lg m-b-sm p-l-r-none">
            <span class="my-profile head">{{ uctrans('custom.help_sections') .' / '. uctrans('custom.pages') }}</span>
        </div>
        <div class="col-xs-6 m-t-lg m-b-md text-right section">
    ...
    <div class="row">
        <div class="col-lg-4 col-xs-12 pull-right m-b-md search-field">
            <form method="GET" action="{{ url('admin/help/pages/list') }}">
                <input
                    type="text"
                    class="m-t-sm input-border-r-12 form-control js-ga-event"
