                            ...
                            <div class="form-group row m-b-lg m-t-md">
                                ...
                                <div class="col-sm-9">
                                    <select name="home_page" class="input-border-r-12 form-control">
                                        <option value="0" @if($model->home_page == 0) selected="selected" @endif>{{ __('custom.admin_regular_news') }}</option>
                                        <option value="1" @if($model->home_page == 1) selected="selected" @endif>{{ __('custom.admin_latest_news') }}</option>
                                        <option value="2" @if($model->home_page == 2) selected="selected" @endif>{{ __('custom.admin_alert_news') }}</option>
                                    </select>
