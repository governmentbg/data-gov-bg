        ...
        <div class="row">
            <div class="col-md-6">
                <a href="{{ url('/users/list') }}" class="reg-users">
                    <p>300</p>
                    <hr>
                    <p>{{ utrans('custom.registered_users') }}</p>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="#" class="updates">
                    <p>182</p>
                    <hr>
                    <p>{{ utrans('custom.agency_nuclear') }} </p>
...
<div class="container-fluid gray-background">
    <div class="container activity-chart">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading"> {{ utrans('custom.activity_dynamics') }} </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="picks-box">
                ...
                <a href="#">
                    <svg data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 77 77"><defs></style></defs><title>{{ utrans('custom.economy_business') }}</title><rect class="cls-1" x="3.69" y="61.61" width="70.5" height="3.39"/><polygon class="cls-1" points="68.84 16.02 70.03 17.7 46.3 34.02 32.11 14 0 36.37 0.01 39.99 31.43 18.1 45.61 37.99 71.73 20.11 72.92 21.8 77 14.56 68.84 16.02"/><polygon class="cls-1" points="4.21 58.84 15.96 58.84 15.96 31.34 4.21 39.75 4.21 58.84"/><polygon class="cls-1" points="71.11 24 60.61 31.42 60.61 58.84 72.36 58.84 72.36 25.76 71.11 24"/><polygon class="cls-1" points="46.51 40.56 46.51 58.84 58.26 58.84 58.26 32.26 46.54 40.54 46.51 40.56"/><polygon class="cls-1" points="18.31 30.5 18.31 58.84 30.06 58.84 30.06 22.07 18.31 30.5"/><polygon class="cls-1" points="32.41 23.78 32.41 58.84 44.16 58.84 44.16 40.85 32.41 23.78"/></svg>
                    <p>{{ utrans('custom.economy_business') }}</p>
                </a>
            </div>
        </div>
    </div>
