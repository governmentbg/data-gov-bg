...
<body class="theme-{{ $class }}">
        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="col-md-2 col-sm-2 m-t-sm hidden-xs access-terms-icons">
                        <a href="{{ url('/terms') }}">
                            <span class="svgIcons">
                    ...
                    <div class="navbar-header col-xs-3 hidden-lg hidden-md hidden-sm text-center">
    ...
    <footer class="footer footer-mobile hidden-lg hidden-md hidden-sm">
        ...
        <div class="copiright text-center col-xs-12">
            ...
            <a target="_blank" href="https://opendata.government.bg/">Портал за отворени данни на РБ</a>
        </div>
    </footer>
