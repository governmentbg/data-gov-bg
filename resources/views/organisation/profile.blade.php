                    ...
                    <div class="col-xs-12 p-l-r-none">
                        <div>
                            <ul class="nav filter-type right-border">
                                <li><a class="active" href="{{ url('/organisation/profile/'. $organisation->uri) }}">{{ __('custom.profile') }}</a></li>
            ...
            <div class="row m-t-lg">
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-6 col-xs-12 info-box m-t-n-sm">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-5 col-xs-12">
                                    <a href="{{ url('/organisation/'. $organisation->uri .'/datasets') }}" class="data-sets">
