                ...
                <div class="article m-b-md">
                    <div class="col-sm-12">
                        ...
                        <div class="info-bar col-sm-7 col-xs-12 p-l-none">
                            <ul class="p-l-none">
                                <li>Автор: {{ $dataset->author_name }}</li>
                                <li>Връзка с Автор: {{ $dataset->author_email }}</li>
                                <li>Отговорник подръжка: {{ $dataset->support_name }}</li>
                                <li>Връзка с отговорник подръжка: {{ $dataset->support_email }}</li>
                                <li>Създаден: {{ $dataset->created_at }}</li>
                            </ul>
                        </div>
                        ...
                        <div class="col-xs-12 pull-left m-t-md p-l-none">
                            <div class="pull-left history">
                                <div class="m-b-sm">
                                    <span class="version">Версия {{ $dataset->version }}</span>
                                </div>
                            </div>
                        </div>
                        <!-- signals -->
                        ...
                        <div class="col-sm-12 m-t-lg p-l-none">
                            <div class="pull-left">
                                <a type="button" class="badge badge-pill m-b-sm" href="{{ url('/user/edit') }}">редактиране</a>
