                    ...
                    @foreach ($roles as $role)
                        <li>
                            <a
                                ...
                                href="{{ route('userGroupMembersView', [
                                    'uri'       => $group->uri,
                            ...
                            <div class="m-r-md p-h-xs col-md-6 invite-choice">
                                ...
                                <ul class="input-border-r-12">
                                    <li>
                                        <a
                                            class="black"
                                            href="{{ url('/user/groups/members/addNew/'. $group->uri) }}"
            ...
            <div class="frame">
                ...
                <div class="modal-body">
                    ...
                    <form
                        ...
                        method="post"
                        action="{{ url('/user/groups/members/'. $group->uri) }}"
                        data-url="{{ url('/user/groups/members/'. $group->uri) }}"
                    >
                        {{ csrf_field() }}
                        <input type="hidden" name="invite_existing">
                        <input type="hidden" name="uri" value="{{ $group->uri }}">
