        ...
        <div class="col-xs-12 m-t-md">
            <div class="row">
                <div class="col-sm-3 cl-xs-12 sidenav m-b-md">
                    ...
                    <span class="badge badge-pill m-t-lg new-data"><a  href="{{ url('/user/orgRegistration') }}">Създаване на организация</a></span>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4 p-md">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <p class="text-right"><a href="{{ url('/organisation/profile') }}" class="view-profile">виж още</a></p>
                                    <div class="control-btns text-center">
                                        <span class="badge badge-pill m-r-md m-b-sm"><a href="{{ url('/user/orgEdit') }}">промяна</a></span>
                                        <span class="badge badge-pill m-b-sm">
                                            <a
                                                href="#"
                                                onclick="return confirm('Изтриване на организация?');"
                                                >изтриване</a>
                                        </span>
                                    </div>
                                </div>
