...
@extends(Request::segment(1) == config('chatter.routes.home') ? Config::get('chatter.master_file_extend') : 'static.empty')
...
@if (Request::segment(1) == config('chatter.routes.home'))
    @section('content')
@endif
                                ...
                                <span class="chatter_posts">
                                    @if(!Auth::guest() && (Auth::user()->id == $post->user->id))
                                        <div id="delete_warning_{{ $post->id }}" class="chatter_warning_delete">
                                            ...
                                            <button class="btn btn-sm btn-default pull-right  discussion-btn">@lang('chatter::messages.response.no_confirm')</button>
                                        </div>
